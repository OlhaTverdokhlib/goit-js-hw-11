...
btnSearch.addEventListener("click", (e)=>{
    e.preventDefault();
    cleanGallery();
    if (input.value !== "") (0, _fetchImages.fetchImages)(input.value, page).then((searchData)=>{
        if (searchData.hits.length === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
        else {
...
btnLoadMore.addEventListener("click", ()=>{
    page += 1;
    btnLoadMore.style.display = "none";
    (0, _fetchImages.fetchImages)(input.value, page).then((searchData)=>{
        if (searchData.hits.length === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
        else {
            createCards(searchData.hits);
            btnLoadMore.style.display = "block";
...
},{"./fetchImages":"8Bjl1","notiflix":"5z0Oc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc"}],"8Bjl1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const fetchImages = async (inputValue, pageNr)=>{
    try {
        const response = await (0, _axiosDefault.default).get(`https://pixabay.com/api/?key=35922442-c118945269cf43d6168aad69e&q=${inputValue}&orientation=horizontal&safesearch=true&image_type=photo&per_page=40&page=${pageNr}`);
